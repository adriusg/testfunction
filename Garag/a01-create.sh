...
echo "<br><img src='qrout.png'><br>" >> /workspace/appConnection/public/index.html
...
echo "<li><a href="$wow4-app-debug.apk">$wow4-app-debug.apk</a><br>" >> /workspace/Garag/public/index.html
