...
# backup old .apk
cp /workspace/appConnection/public/$wow4-app-debug.apk /workspace/my-gitpod-dockerfile-cordova/public/$wow4-backup-app-debug.apk

#copy new .apk to the public folder
cp /workspace/appConnection/$wow4/platforms/android/app/build/outputs/apk/debug/app-debug.apk /workspace/Garag/public/$wow4-app-debug.apk
...
echo "<li> Next rebuild <a href="$wow4-app-debug.apk">$wow4-app-debug.apk</a><br>" >> /workspace/Garag/public/index.html
